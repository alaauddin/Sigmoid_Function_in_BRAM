...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Sigmoid_Function_in_BRAM/Sigmoid_Function_in_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sigmoid_BRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sigmoid_BRAM.tcl -notrace
