...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Sigmoid_Function_in_BRAM/Sigmoid_Function_in_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sigmoid_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sigmoid_BRAM.tcl
